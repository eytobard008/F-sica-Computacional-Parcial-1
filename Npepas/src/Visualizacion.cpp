...
void GenerarAnimacion(const string &archivoDat, const string &archivoPresion, double W, double H, int N, int pasos, double dt, double R, bool usarMalla, double velocidadMedia, double dispersionVelocidad, const string &nombreGif) {
